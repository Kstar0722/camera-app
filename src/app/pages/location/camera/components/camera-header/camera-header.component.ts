...
@Component({
  selector: 'app-camera-header',
  templateUrl: './camera-header.component.html',
  styleUrls: ['./camera-header.component.scss']
})
export class CameraHeaderComponent implements OnInit {
